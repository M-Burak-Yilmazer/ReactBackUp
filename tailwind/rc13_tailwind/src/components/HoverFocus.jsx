...
const HoverFocus = () => {
  return (
    <>
      <div>
        <button className="w-40 bg-sky-400 hover:bg-sky-500 text-slate-50 rounded-full py-2 mx-1 focus:fuchsia-600 shadow-slate-900 hover:shadow-2xl focus:ring-4 focus:ring-sky-900">
          Save
        </button>
